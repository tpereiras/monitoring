...
from .views import (
    ...
    RestorePasswordView, RestorePasswordDoneView, RestorePasswordConfirmView, ChangeCompanyInfo,
)
...
urlpatterns = [
    ...
    path('change/company/', ChangeCompanyInfo.as_view(), name='change_company'),
